        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-in slide-in-from-left-8 duration-700 fade-in">
            ...
            <div 
              ...
              role="status"
              aria-label="Status: Enrollment Open for Fall 2025"
            >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold text-white leading-[1.1]">
              Forge Your Legacy as a <span className="text-brand-400 italic">Master Barber</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <button 
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-transparent text-white border-2 border-stone-400 rounded-sm font-bold text-lg hover:bg-white hover:text-stone-900 hover:border-white transition-all focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-stone-900 active:scale-95"
              >
                View Curriculum
              </button>
            </div>
          ...
          <div className="relative hidden lg:block" aria-hidden="true">
            ...
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              <div className="relative h-[600px] w-full overflow-hidden bg-stone-900">
                <img 
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md p-6 rounded-lg shadow-2xl border-l-4 border-brand-500">
                ...
                <p className="text-stone-800 font-medium text-base italic leading-snug mb-4">"The instructors don't just teach you how to cut; they teach you how to build a brand."</p>
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-stone-200 overflow-hidden ring-2 ring-brand-500/20">
            ...
            <div className="absolute -z-10 top-4 -right-4 w-full h-full border-2 border-brand-500/30 rounded-lg"></div>
          </div>
        </div>
      </div>
    </section>
